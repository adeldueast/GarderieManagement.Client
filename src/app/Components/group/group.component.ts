...
export class GroupComponent implements OnInit,OnDestroy {
  ...
  ngOnInit() {
    ...
    this.signalRService.addChildAttendanceChangesListener(this.updateChildState.bind(this))
  }
  updateChildState(data?:any){
    const index =  this.group.enfants.findIndex((x:any) => x.id ===  data.enfantId);
    if(index!= -1){
